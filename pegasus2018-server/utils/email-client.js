...
var sendEmail = (requestObject) => {
    ...
    var message = {
        ...
        html: '<p>Hello,</p>' +
            ...
            investigatorsList +
            `Proposal:  <a href="${requestObject.linkToProposal}">${requestObject.proposalName}</a>` +
            `<br>Budget:  <a href="${requestObject.linkToBudget}">${requestObject.budgetName}</a>` 
    }
